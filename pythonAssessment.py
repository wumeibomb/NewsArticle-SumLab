...
text_to_analyze = "With the dhvbwh vsjdvs sdijnvsjk sdfwknv sd vbweif vkdbvhiw d viwbv whvb wdv iwb vkd icbad visbdv wi vsd vob vn iv wknv whi vwnbvwd viw v sbvsihvb wvwi vm vbreak break statement we can stop the loop before it has looped through all the items, break in the statment break"
...
def calculate_average_word_length(str):
    ...
    bjjb = re.findall(pattern, str)

    for eachcharacter in bjjb:
         count += 1
